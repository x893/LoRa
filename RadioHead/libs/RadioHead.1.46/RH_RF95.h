...
private:
	...
	uint8_t _resetPin;
	/// The configured power enable pin connected to this instance
	uint8_t _powerPin;
	/// Version code of the chip.
	///	Bits 7-4 give the full revision number;
	/// bits 3-0 give the metal mask revision
	uint8_t _revision;
};
