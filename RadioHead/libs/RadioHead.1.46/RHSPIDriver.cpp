...
uint8_t RHSPIDriver::spiReadNoneBlocking(uint8_t reg)
{
    uint8_t val;
...
uint8_t RHSPIDriver::spiWriteNoneBlocking(uint8_t reg, uint8_t val)
{
    uint8_t status;
...
uint8_t RHSPIDriver::spiBurstReadNoneBlocking(uint8_t reg, uint8_t* dest, uint8_t len)
{
    uint8_t status;
...
uint8_t RHSPIDriver::spiBurstWriteNoneBlocking(uint8_t reg, const uint8_t* src, uint8_t len)
{
    uint8_t status;
