...
protected:
	...
	volatile RHMode _mode;				/// The current transport operating mode
	...
	volatile int8_t _lastRssi;			/// The value of the last received RSSI value, in some transport specific units
