...
// Type: SemtechLib.Devices.SX1276.Events.PreamblePolarityEventArg
...
{
  public class PreamblePolarityEventArg : EventArgs
  {
    private PreamblePolarityEnum value;

    public PreamblePolarityEnum Value
    {
      get
      {
        return this.value;
