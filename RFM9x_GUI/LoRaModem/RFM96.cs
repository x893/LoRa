namespace LoRaModem
{
	public class RFM96
	{
		...
		public RegType RegFrMsb = new RegType("RegFrMsb", (byte)6, (byte)108);
		public RegType RegFrMid = new RegType("RegFrMid", (byte)7, 0x80);
		public RegType RegFrLsb = new RegType("RegFrLsb", (byte)8, (byte)0);
		public RegType RegPaConfig = new RegType("RegPaConfig", (byte)9, (byte)79);
		public RegType RegPaRamp = new RegType("RegPaRamp", (byte)10, (byte)9);
		...
		public RegType RegModemConfig1 = new RegType("RegModemConfig1", (byte)29, (byte)114);
		public RegType RegModemConfig2 = new RegType("RegModemConfig2", (byte)30, (byte)112);
		...
		public RegType RegModemConfig3 = new RegType("RegModemConfig3", (byte)38, (byte)0);
		public RegType RegVersion = new RegType("RegVersion", (byte)66, (byte)18);
		public RegType RegTcxo = new RegType("RegTcxo", (byte)75, (byte)9);
		public RegType RegPaDac = new RegType("RegPaDac", (byte)77, (byte)132);
		public RegType RegPllHf = new RegType("RegPllHf", (byte)112, (byte)208);
