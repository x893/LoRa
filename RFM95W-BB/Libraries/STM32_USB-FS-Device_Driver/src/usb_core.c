...
#define vSetEPRxStatus(st)	(pInformation->SaveRState = st)
#define vSetEPTxStatus(st)	(pInformation->SaveTState = st)
...
void DataStageIn(void)
{
	...
	CONTROL_STATE ControlState = pInformation->ControlState;
